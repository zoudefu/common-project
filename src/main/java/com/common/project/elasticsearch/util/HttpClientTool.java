...
public class HttpClientTool {
    ...
    private static synchronized HttpClient getESHttpClient() {
        if (mHttpClient == null) {
            ...
            // = new PoolingClientConnectionManager(schReg);
    ...
    private static synchronized HttpClient getESHttpClient(String username, String password) {
        if (mHttpClient == null) {
     ...
     * @return
     */
    private static CloseableHttpClient getHttpClientWithBasicAuth(String username,
            String password) {
